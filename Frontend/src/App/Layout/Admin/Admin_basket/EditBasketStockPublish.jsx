...
const EditBasketStockPublish = () => {
	...
	return (
		<Content
			Page_title="Edit Basket Published stock"
			button_status={false}
		...
		>
			...
			<DynamicForm
				...
				sumit_btn={true}
				btnstatus={loading}
				btn_name1_route={"/admin/basket/basketstockpublish"}
				additional_field={<></>}
...
export default EditBasketStockPublish
