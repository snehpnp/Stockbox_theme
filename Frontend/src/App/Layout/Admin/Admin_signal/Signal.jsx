                                        ...
                                        <div className="col-md-12" key={index}>
                                            <div className="card radius-10 mb-3 border">
                                                <div className="card-body">
                                                    ...
                                                    <p className="mb-1">
                                                        {client?.calltype} {client?.stock} {client?.expirydate && `${client.expirydate}`}
                                                        {client?.optiontype && `${client.optiontype}`} {client?.calltype} {client?.entrytype}
                                                        {client?.price} Target {client?.tag1}
                                                        {client?.tag2 && `/${client.tag2}`} {client?.tag3 && `/${client.tag3}`}
