        ...
        try {
            ...
            if (response.status) {
                if (response.data?.length > 0) {
                    ...
                    const csvArr = filterdata.map((item) => {
                        const entryType = `${item?.calltype} ${item?.stock} ${item?.expirydate ? `Expiry: ${item.expirydate}` : ""
                            } ${item?.optiontype ? `Option: ${item.optiontype}` : ""
                            } Entry Type: ${item?.entrytype} Price: ${item?.price} Target: ${item?.tag1
                            } ${item?.tag2 ? `/${item.tag2}` : ""} ${item?.tag3 ? `/${item.tag3}` : ""
        ...
        try {
            ...
            if (result.isConfirmed) {
                ...
                if (response.status) {
                    showCustomAlert(
                        "Success",
                        "The Signal has been successfully deleted."
                    );
                    getAllSignal();
                }
            } else {
        ...
        try {
            ...
            if (index === 1) {
                ...
                if (closedata.calltype === "BUY") {
                    ...
                    if (target2 && !target1) {
                        showValidationError(
                            "Target 1 must be provided if Target 2 is entered."
                        );
                        return;
                    }
                    if (target3 && (!target1 || !target2)) {
                        showValidationError(
                            "Target 1 and Target 2 must be provided if Target 3 is entered."
                        );
                        return;
                    }
            ...
            const data = {
                ...
                targethit1:
                    index === 1 && closedata.targetprice1 ? 1 : checkedTargets1.target1,
                targethit2:
                    index === 1 && closedata.targetprice2 ? 1 : checkedTargets1.target2,
                targethit3:
                    index === 1 && closedata.targetprice3 ? 1 : checkedTargets1.target3,

                targetprice1:
                    index === 0
                        ? closedata.tag1
                        : index === 1
                            ? closedata.targetprice1
                            : "",
                targetprice2:
                    index === 0
                        ? closedata.tag2
                        : index === 1
                            ? closedata.targetprice2
                            : "",
                targetprice3:
                    index === 0
                        ? closedata.tag3
                            ...
                            <div className="d-md-flex align-items-center mb-4 gap-3">
                                ...
                                <div className="ms-sm-auto mt-2 mt-md-0">
                                    <Link to="/admin/addsignal" className="btn btn-primary">
                                        <i className="bx bxs-plus-square" aria-hidden="true" /> Add
                                        Signal
                                    </Link>
                                </div>
                                ...
                                <div className="ms-0 ms-md-2 mt-2 mt-md-0">
                                    {viewMode === "table" ? (
                                        ...
                                        >
                                            <i className="bx bxs-download" aria-hidden="true" />{" "}
                                            Export-Excel
                                        </button>
                                    ) : (
                                        <button
                                                ...
                                                <div className="card radius-10 mb-3 border">
                                                    <div className="card-body">
                                                        ...
                                                        <p className="mb-1">
                                                            ...
                                                            {client?.calltype} {client?.entrytype}{" "}
                                                            {client?.price} Target {client?.tag1}
                    ...
                    <>
                        ...
                        <div className="card">
                            {checkedIndex === 0 && (
                                <form className="card-body">
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => closeSignalperUser(0, e)}
                                    >
                                        Submit
                                    </button>
                                </form>
                            ...
                            {checkedIndex === 1 && checkedIndex === 1 && (
                                <form
                                    className="card-body"
                                    onSubmit={(e) => closeSignalperUser(1, e)}
                                >
                                    <div className="col-md-12">
                            ...
                            {checkedIndex === 2 && (
                                <form className="card-body">
                                    ...
                                    <button
                                        type="submit"
                                        className="btn btn-primary mt-2"
                                        onClick={(e) => closeSignalperUser(2, e)}
                                    >
                                        Submit
                                    </button>
                                </form>
                            ...
                            {checkedIndex === 3 && (
                                <form className="card-body">
                                    ...
                                    <button
                                        type="submit"
                                        className="btn btn-primary mt-2"
                                        onClick={(e) => closeSignalperUser(3, e)}
                                    >
                                        Submit
                                    </button>
                                </form>
                            ...
                            {checkedIndex === 4 && (
                                <form className="card-body">
                                    ...
                                    <button
                                        type="submit"
                                        className="btn btn-primary mt-2"
                                        onClick={(e) => closeSignalperUser(4, e)}
                                    >
                                        Submit
                                    </button>
                                </form>
