...
const Signal = () => {
    ...
    const Signaldetail = async (_id) => {
        navigate(`/admin/signaldetaile/${_id}`, { state: { openSignal: "openSignal" } })
    }
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="d-md-flex align-items-center mb-4 gap-3">
                                ...
                                <div >
                                    <Link to="/admin/multiplesignal" className="btn btn-primary">
                                                ...
                                                <div className='row w-100 mx-auto'>
                                                    <div className='col-md-3'>
                                                        <div className='d-flex flex-column gap-3 p-4 sticky-card'>
                                                            ...
                                                            <button className='btn btn-secondary w-100' onClick={() => navigate(`/admin/multipleSignaldetail/${strategy._id}`)}>View</button>
