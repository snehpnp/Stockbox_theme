...
const ReferAndEarnlist = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => <div> <IndianRupee />{row?.receiveramount?.toFixed(2)}</div>,
            sortable: true,
            width: '250px',
        },
        {
            name: 'Sender Amount',
            selector: row => <div> <IndianRupee />{row?.senderamount?.toFixed(2)}</div>,
            sortable: true,
            width: '250px',
        },
        {
            name: 'Receiver Earn',
            selector: row => <div> <IndianRupee />{row?.receiverearn?.toFixed(2)}</div>,
            sortable: true,
            width: '200px',
        },
        {
            name: 'Sender Earn',
            selector: row => <div> <IndianRupee />{row?.senderearn?.toFixed(2)}</div>,
            sortable: true,
            width: '200px',
        },
