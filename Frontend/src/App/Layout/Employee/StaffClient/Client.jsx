...
const Client = () => {
    ...
    useEffect(() => {
        getAdminclient();
    }, [permission, searchInput, searchkyc, statuscreatedby, currentPage, expired, filters.fromDate, filters.toDate]);
                            ...
                            : clientStatus === "active"
                                ...
                                : clientStatus === "expired"
                                    ...
                                    : expired === "NA"
                                        ? "NA"
                                        : "",
                add_by: "", add_by: permission.includes("Ownclient") ? userid : "",
            ...
            if (response.status && response.data?.length > 0) {
                ...
                const csvArr = response.data?.map((item) => ({
                    ...
                    ClientExpiredSegment: item?.plansStatus
                        ...
                        .map((statusItem) => statusItem.serviceName || "N/A")
                        .join(", ") || "N/A",
                    CreatedBy: item?.addedByDetails?.FullName || (item?.clientcome === 1 ? "WEB" : "APP") || "N/A",
        ...
        permission.includes("clientchangestatus") && {
            ...
            selector: (row) => (
                <div className="form-check form-switch form-check-info">
                    ...
                    />
                    <label htmlFor={`rating_${row._id}`} className="checktoggle checkbox-bg"></label>
                </div>
            ),
            sortable: true,
            width: "165px",
            ...
            selector: (row) => (
                <div className="d-flex justify-content-end gap-2">
                    ...
                    {permission.includes("viewdetail") && <Tooltip title="view">
                        <Eye onClick={() => Clientdetail(row)} style={{ color: "green" }} />
                    </Tooltip>}
                    {permission.includes("editclient") && <Tooltip title="Update">
                        <SquarePen className="" onClick={() => updateClient(row)} style={{ color: "#6f42c1" }} />
                    </Tooltip>}
                </div>
            ),
            ignoreRowClick: true,
    ...
    return (
        <div>
                    ...
                    <div className="card-body">
                        <div className="d-lg-flex align-items-center mb-4 gap-3">
                            ...
                            <div className="d-sm-flex gap-3 justify-content-lg-end w-100 mt-3 mt-lg-0">
                                {permission.includes("addclient") && <div className="flaot-lg-auto">
                                ...
                                {/* <div className="">
                                    <Link to="/admin/clientdeletehistory" className="btn btn-primary">
                                        <i className="bx bxs-trash" aria-hidden="true" /> Deleted Client
                                    </Link>
                                </div> */}
                            </div>
                        </div>
            ...
            <ReusableModal
                ...
                body={
                    <>
                        ...
                        <div className="card">
                                            ...
                                            category
                                                ...
                                                .map((item, index) => (
                                                    <div className="col-lg-4 mb-3" key={index}>
                                                        <input
                                                            style={{ border: "1px solid #ddd", margin: "0 8px 1px" }}
                                                        ...
                                                        >
                                                            {item.title} ({item.servicesDetails.map((service) => service.title).join(", ")})
                                                        </label>
                                                    </div>
                                                ))}
                                    </div>
                                                                    ...
                                                                    <div className="accordion" id={`accordion-${selectcategory}`}>
                                                                        <div className="accordion-item">
                                                                            <h2 className="accordion-header" id={`heading-${item._id}`}>
                                                                                <button
                                                                                    className={`accordion-button ${selectedPlanId === item._id ? "" : "collapsed"
                                                                                ...
                                                                                >
                                                                                    <div className="d-flex justify-content-between w-100">
                                                                                        <div>
                                                                                            <strong className="heading-color m-2">Detail</strong>
                                                                                            <strong className="text-success m-2 activestrong">
                                                                                                {item?.subscription?.status === "active" ? "Active" : ""}
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>
                                                                                </button>
                            ...
                            {checkedIndex === 1 && (
                                <>
                                    <div className="card-body my-3" style={{ height: "40vh", overflowY: "scroll" }}>
                                        <div className="row">
                                                                ...
                                                                <div className="accordion-item">
                                                                    <h2 className="accordion-header" id={`heading-${item._id}`}>
                                                                        ...
                                                                        >
                                                                            <div className="d-flex justify-content-between w-100">
                                                                                <div>
                                                                                    <strong className="m-2 heading-color">Detail</strong>
                                                                                    <strong className="text-success m-2 activestrong">
                                                                                        {item?.client_status === "active" ? "Active" : ""}
                                                                                    </strong>
                                                                                </div>
                                                                            </div>
                                                                        </button>
                ...
                footer={
                    <>
                        <button className="btn btn-primary rounded-1" onClick={() => handleCancel()}>
                            Cancel
                        </button>
                        {checkedIndex === 0 && (
                            <button
