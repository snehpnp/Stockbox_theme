...
function CardForm() {
  ...
  return (
    <Contnet Page_title="Card Form">
      <div>
        <form onSubmit={handleSubmit}>
          <div className='row'>
            <div className='col-md-6'>
            <input type="text" name="username" placeholder="User Name *" onChange={handleChange} style={cardInput} />
            </div>
            <div className='col-md-6'>
              <input type="text" name="fullfame" placeholder="Full Name *" onChange={handleChange} style={cardInput} />
            </div>
            <div className='col-md-6'>
              <input type="email" name="email" placeholder="Email *" onChange={handleChange} style={cardInput} />
            </div>
            <div className='col-md-6'>
              <input type="number" name="mobile" placeholder="Mobile *" onChange={handleChange} style={cardInput} />
            </div>
            <div className='col-md-6'>
              <select name="licence" onChange={handleChange} style={cardInput}>
            ...
            <div className='col-md-6'>
              <select name="broker" onChange={handleChange} style={cardInput}>
            ...
            <div className='col-md-6'>
              <select name="parent_id" onChange={handleChange} style={cardInput}>
            ...
            <div className='col-md-6'>
              <select name="groupservice" onChange={handleChange} style={cardInput}>
