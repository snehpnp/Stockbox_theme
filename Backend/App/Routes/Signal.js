...
const {AddSignal,getSignal,deleteSignal,detailSignal,closeSignal,targethitSignal,getSignalWithFilter,updateReport,showSignalsToClients,allShowSignalsToClients,AddSignalwithPlan,getPlansByService,getSymbol,getSignalWithFilterplan,closeSignalwithplan,getSignalWithFilterExport,getSignalWithFilterplanExport,AddSignals,getSignalsListWithFilte,closeSignals,updateReports,detailSignals} = require('../Controllers/Signal')
...
router.post('/signal/closesignalwithstock', closeSignals);

router.post('/signal/getsignalslistwithfilte', getSignalsListWithFilte);

router.post('/signal/updatereports', updateReports);
router.get('/signal/detailstrategy/:id', detailSignals);
