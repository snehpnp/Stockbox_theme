...
router.get('/api/list/planbycategorys/:id', getPlansByPlancategoryIds); 
...
router.get('/api/list/notificationwithplan/:id', NotificationWithPlan);
...
router.post('/api/list/getbasketgraphdata', getBasketGraphData);
router.post('/api/list/basketsubscriptioncount', BasketSubscriptionCount);

router.get('/api/getliveprices/:basket_id', getLivePrices);
router.get('/api/getlivepricecash', getLivePriceCash);

router.post('/api/list/signalclientwithplanstrategy', SignalClientWithPlanStrategy);
router.post('/api/list/signalclientwithplanclosestrategy', SignalClientWithPlanCloseStrategy);
router.get('/api/list/getstates', getAllStates);
router.get('/api/list/getcitybystates/:stateName', getCityByStates);
router.get('/api/list/countsignalstatus', countSignalStatus);
...
router.post('/api/list/addrating', addRating); 
router.get('/api/list/clover', Cloverlist); 
